        ...
        <form method="POST" action="">
            ...
            <div class="mb-3">
                ...
                <input type="tel" class="form-control @error('phone') is-invalid @enderror" id="phone"
                    name="phone" value="{{ old('phone') }}" placeholder="+62 812 3456 7890">
                @error('phone')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="form-check">
                ...
                <label class="form-check-label" for="terms">
                    Saya setuju dengan <a href="javascript:void(0)" style="color: var(--primary-green); text-decoration: none;">Syarat & Ketentuan</a>
                </label>
                @error('terms')
